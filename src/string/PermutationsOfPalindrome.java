...
public class PermutationsOfPalindrome {
    ...
    /**
     * This method calculates frequency of each character in the string and adds it to the frequency table
     *
     */
    ...
    public static void main(String[] args) {
        ...
        if (solution) {
            System.out.println("String " + str + " has permutations of palindrome for the string");
        } else {
            System.out.println("String " + str + " does not have permutations of palindrome for the string");
        }
    }
}
