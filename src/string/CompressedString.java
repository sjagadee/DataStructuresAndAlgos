 ...
 *
 * Compressed String would return us back the smallest string
 * after the compression is complete, we check if the compressed string is smaller
 * if it is, then we return the compressed string,
 * otherwise we return the string which was passed
 */
